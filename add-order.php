   ...
   $stall_no= $n."".$l; ?>
                                     ...
                                     <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                <input type="text" class="form-control" id="clientContact" name="clientContact" placeholder="Contact Number No." autocomplete="off" pattern="^[0][0-9]\d{9}$|^[0-9]\d{9}$" required/>
                                               </div>
...
<td >
            ...
            ?>
              ...
              <input type="hidden" class="form-control" id="subTotalValue" name="subTotalValue" />
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label for="vat" class="col-sm-2 control-label gst"></label>
                                                <div class="col-sm-4">
            ...
            <div class="col-sm-4">
              <select class="form-control" name="paymentType" id="paymentType">
                ...
                <option value="2">Credit Card</option>
                                            ...
                                            <div class="form-group">
                                            <div class="row">
                                               <label for="clientContact" class="col-sm-2 control-label"></label>
